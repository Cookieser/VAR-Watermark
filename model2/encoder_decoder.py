...
class EncoderDecoder(nn.Module):
    ...
    # MSE image + VGG + decoder only
    # encoder channel 32, decoder channel 3, discriminator channel 3
    def forward(self, embedding, message,var,batch):  
        ...
        return original_image, encoded_image, noised_image, decoded_message
